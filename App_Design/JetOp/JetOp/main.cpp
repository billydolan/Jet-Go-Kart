...
ID3D11Buffer* g_pVertexBuffer = NULL;  // Vertex buffer for custom rendering
...
bool CreateDeviceD3D(HWND hWnd) {
    ...
    CreateRenderTarget();
    CreateVertexBuffer();  // Create custom buffer
    return true;
}

void CleanupDeviceD3D() {
    CleanupRenderTarget();
    CleanupVertexBuffer();  // Cleanup custom buffer
...
void CreateVertexBuffer() {
    ...
    g_pd3dDevice->CreateBuffer(&bufferDesc, &initData, &g_pVertexBuffer);
}
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE, LPWSTR, int nCmdShow) {
    ...
    // Initialize ImGui for DirectX11 and Win32
